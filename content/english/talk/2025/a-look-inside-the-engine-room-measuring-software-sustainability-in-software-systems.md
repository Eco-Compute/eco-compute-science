...
The research is being directly applied in practice: In an industrial context, the CO₂e footprint of IT landscapes is being transparently measured. This includes emissions from hyperscalers (e.g., Azure, AWS), data centers (including private clouds), and end-user devices such as laptops and printers.
