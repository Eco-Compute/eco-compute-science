...
While the industry talks about sustainability, it lacks hard data: isolated metrics like PUE dominate, and tech giants publish unverifiable claims – such as 0.03 g CO₂ per LLM prompt (excluding training, undefined prompt size, and based on market-based emissions), or that their cloud is 4.1 times more energy efficient than on-premises – without any explanation or evidence.
